...
public class BarChartProcessor implements ChartProcessor {
	...
	private static final Logger logger = Logger.getLogger(BarChartProcessor.class.getName());
	
	@Override
	public void process(UIComponentBase component, FacesContext context)
			throws IOException {
		logger.info("Rendering Bar Chart .....");
		...
		ChartData data = ChartDataGenerator.generateBarChartData(xDataArray, yDataArray, label);
